...
public class SimpleCacheStatistics implements CacheStatisticsMXBean, CacheStatistics {
    ...
    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics reset() {
        cacheHits.set(0);
        cacheGets.set(0);
        cachePuts.set(0);
        cacheRemovals.set(0);
    ...
    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cacheHits() {
        cacheHits.incrementAndGet();
        return this;
    }

    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cacheGets() {
        cacheGets.incrementAndGet();
        return this;
    }

    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cachePuts() {
        cachePuts.incrementAndGet();
        return this;
    }

    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cacheRemovals() {
        cacheRemovals.incrementAndGet();
        return this;
    }

    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cacheEvictions() {
        cacheEvictions.incrementAndGet();
        return this;
    }

    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cacheGetsTime(long costTime) {
        cacheGetTime.add(costTime);
        return this;
    }

    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cachePutsTime(long costTime) {
        cachePutTime.add(costTime);
        return this;
    }

    @Override
    public org.geektimes.cache.management.SimpleCacheStatistics cacheRemovesTime(long costTime) {
