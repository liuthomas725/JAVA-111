...
class KeyValueTypePair {
    ...
    public boolean equals(Object o) {
        ...
        org.geektimes.cache.KeyValueTypePair that = (org.geektimes.cache.KeyValueTypePair) o;
    ...
    public static org.geektimes.cache.KeyValueTypePair resolve(Class<?> targetClass) {
        assertCache(targetClass);

        List<Class<?>> typeArguments = resolveTypeArguments(targetClass);
        if (typeArguments.size() == 2) {
            return new org.geektimes.cache.KeyValueTypePair(typeArguments.get(0), typeArguments.get(1));
        }
        return null;
    }
