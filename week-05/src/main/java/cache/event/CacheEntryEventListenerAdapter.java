...
import org.geektimes.cache.event.ConditionalCacheEntryEventListener;
...
public class CacheEntryEventListenerAdapter<K, V> implements ConditionalCacheEntryEventListener<K, V> {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof org.geektimes.cache.event.CacheEntryEventListenerAdapter)) {
            return false;
        }
        org.geektimes.cache.event.CacheEntryEventListenerAdapter another = (org.geektimes.cache.event.CacheEntryEventListenerAdapter) object;
