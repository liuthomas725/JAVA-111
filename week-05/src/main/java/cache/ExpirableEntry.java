...
public class ExpirableEntry<K, V> implements Cache.Entry<K, V>, Serializable {
    ...
    public static <K, V> org.geektimes.cache.ExpirableEntry<K, V> of(Map.Entry<K, V> entry) {
        return new org.geektimes.cache.ExpirableEntry(entry.getKey(), entry.getValue());
    }

    public static <K, V> org.geektimes.cache.ExpirableEntry<K, V> of(K key, V value) {
        return new org.geektimes.cache.ExpirableEntry(key, value);
    }
