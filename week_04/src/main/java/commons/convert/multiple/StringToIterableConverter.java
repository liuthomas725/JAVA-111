 ...
 */
package commons.convert.multiple;


import commons.convert.StringConverter;

import java.util.Collection;
import java.util.Optional;

import static commons.convert.Converter.getConverter;
import static commons.reflect.util.ClassUtils.getAllInterfaces;
import static commons.reflect.util.ClassUtils.isAssignableFrom;
import static commons.reflect.util.TypeUtils.findActualTypeArgument;
